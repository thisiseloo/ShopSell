  ...
  const steps = [
    {
      ...
      title: t("shipping_step1_title"),
      text: t("shipping_step1_text"),
    },
    {
      icon: (
        <PiNumberCircleTwoLight className="text-purple-900 w-6 h-6 sm:w-8 sm:h-8" />
      ),
      title: t("shipping_step2_title"),
      text: t("shipping_step2_text"),
    },
    {
      icon: (
        <PiNumberCircleThreeLight className="text-purple-900 w-6 h-6 sm:w-8 sm:h-8" />
      ),
      title: t("shipping_step3_title"),
      text: t("shipping_step3_text"),
    },
  ];
