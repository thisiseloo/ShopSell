        ...
        <div className="max-w-7xl mx-auto px-4 flex flex-col sm:flex-row justify-between gap-16 pb-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 sm:w-2/3">
            ...
            <div>
              ...
              <div className="flex flex-col gap-2 text-sm">
                <a href="#" className="text-gray-100 hover:underline">Müştəri dəstəyi</a>
                <a href="#" className="text-gray-100 hover:underline">Qaydalar və Şərtlər</a>
                <a href="#" className="text-gray-100 hover:underline">Məxfilik siyasəti</a>
                <a href="#" className="text-gray-100 hover:underline">Sifariş və Çatdırılma</a>
                <a href="#" className="text-gray-100 hover:underline">Qaytarmalar</a>
              </div>
            </div>
            ...
            <div>
              <h3 className="text-lg font-semibold mb-4">Əlavə Məlumat</h3>
              <div className="flex flex-col gap-2 text-sm">
                <a href="#" className="text-gray-100 hover:underline">Tez-tez verilən suallar</a>
                <a href="#" className="text-gray-100 hover:underline">Ödənişlər</a>
                <span className="text-gray-100">İş saatları: 09:00 - 12:00</span>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="flex items-center gap-3 text-2xl justify-center sm:justify-start">
                ...
                <a href="#" className="text-white hover:text-gray-200"><FaPinterestP /></a>
