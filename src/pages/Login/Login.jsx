  ...
  return (
    <div className="min-h-screen flex justify-center items-center bg-gray-200 px-4 sm:px-6 md:px-8 mt-[20px] mb-[110px] lg:mt-0 lg:mb-0">
      <form onSubmit={handleSubmit} className="bg-white p-5 sm:p-6 md:p-8 rounded shadow-md w-full max-w-xs sm:max-w-sm md:max-w-md">
        <h2 className="text-lg sm:text-xl md:text-2xl font-bold mb-5 sm:mb-6 text-center">Hesaba giriş</h2>
        {error && <div className="bg-red-100 text-red-700 p-2 mb-4 rounded text-xs sm:text-sm md:text-base">{error}</div>}
        <label className="block mb-2 font-semibold text-xs sm:text-sm md:text-base">Email və ya İstifadəçi adı</label>
