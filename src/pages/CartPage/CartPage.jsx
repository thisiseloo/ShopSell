...
const CartPage = () => {
  ...
  return (
    <div className="max-w-5xl mx-auto p-4 sm:p-6 md:p-10 mb-[200px] pt-[70px] mt-10 bg-gray-50 rounded-lg shadow-lg pb-24 sm:pb-[100px]">
        ...
        {cart.map((item) => (
          ...
          >
            ...
            <div className="flex-1 text-center sm:text-left">
              ...
              {item.size && (
                <p className="text-xs sm:text-sm text-[#1a0029]/70">
                  {t("size")}: {item.size}
                </p>
              )}
      ...
      <div className="mt-6 flex flex-col sm:flex-row justify-between items-center gap-3">
        ...
        <div className="flex gap-3 mt-3 sm:mt-0">
          <button
            ...
            className="w-[250px] bg-white text-gray-700 border border-gray-400 py-2 rounded-[50px] font-medium hover:bg-gray-100 transition"
          >
            {t("clearCart")}
          </button>
          <button
            onClick={() => setIsOrderModalOpen(true)}
            className="w-[250px] bg-[#290041] border-[1px] border-[#290041] text-white py-2 rounded-[50px] font-medium shadow hover:bg-gray-300 hover:!text-[#1a0029] hover:!border-[#1a0029] transition"
          >
            {t("completeOrder")}
          </button>
        </div>
