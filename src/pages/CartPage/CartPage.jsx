...
const CartPage = () => {
  ...
  if (cart.length === 0) {
    return (
      <div className="p-6 sm:p-10 text-center text-gray-600 text-base sm:text-lg">
        Səbətiniz boşdur.
      </div>
    );
  }
          ...
          >
            ...
            <div className="flex-1 text-center sm:text-left">
              ...
              <p className="text-pink-600 font-bold text-sm sm:text-base">
                {item.price} <span className="text-xs sm:text-sm">AZN</span>
              </p>
            </div>
            ...
            <button
              ...
              className="p-1 sm:p-2 text-gray-500 rounded hover:text-red-600 transition"
